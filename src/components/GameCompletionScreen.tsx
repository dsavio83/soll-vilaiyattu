...
import { Trophy, Clock, Target, Star, Award, TrendingUp, Calendar, Users, Brain, Sparkles, Timer } from 'lucide-react';
...
const GameCompletionScreen = ({ studentData, todayScore, onLogout, onViewLeaderboard }: GameCompletionScreenProps) => {
